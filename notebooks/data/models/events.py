...
def _(mo):
    ...
    metrics — see commits.py for details.
...
def _(mo):
    ...
    and `canonical_developer_id`, see commits.py.
    """)
    return
...
def _(mo):
    ...
    These enriched fields are available in commits.py. The event model
    ...
    See repositories.py and ecosystems.py
