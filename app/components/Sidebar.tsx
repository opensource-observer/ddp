  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed top-3 left-3 z-50 md:hidden p-2 rounded-lg bg-[var(--sidebar-bg)] border border-[var(--sidebar-border)] shadow-sm"
        aria-label="Open menu"
      >
        <Menu className="h-5 w-5 text-[var(--sidebar-primary)]" />
      </button>
      ...
      >
        ...
        <div className="px-4 py-3 border-b border-[var(--sidebar-border)] flex items-center justify-between">
          <Link
            ...
            className="flex items-center gap-2.5 rounded-lg px-1 py-1 hover:bg-[var(--sidebar-accent)] transition-colors"
          >
          ...
          <button
            onClick={() => setMobileOpen(false)}
            className="md:hidden p-1 rounded-md hover:bg-[var(--sidebar-accent)] transition-colors"
            aria-label="Close menu"
          >
            <X className="h-5 w-5 text-[var(--sidebar-muted)]" />
          </button>
        </div>
